...
class Data(BaseModel):
    ...
    source_text: str
    text_type: str
    identity_description: str = "You are an overseas study expert`, if text contains `International Year` you need tanslate `International Year Zero` or `International Year 0` to `预科`, `International Year One` or `International Year 1` to `国际大一`, `International Year Two` or `International Year 2` to `国际大二`, other `Internation Year xx` do the same as so on."
    country: str = "China"
